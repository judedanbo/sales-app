...
const mockPromise = {
    promise: <T,>(promise: Promise<T>, options: { loading: string; success: string; error: string }) => {
        ...
        promise.then(() => success(options.success)).catch(() => error(options.error));
        return promise;
    },
};
        ...
        <div class="space-y-8 p-8">
            ...
            <Card>
                ...
                <CardContent class="space-y-4">
                    <Alert v-for="alert in staticAlerts" :key="alert.variant" :variant="alert.variant">
            ...
            <Card>
                ...
                <CardContent class="space-y-4">
                    ...
                    <div class="mt-4 rounded-lg bg-muted p-4">
                        <p class="mb-2 text-sm text-muted-foreground">Debug Info:</p>
            ...
            <Card>
                ...
                <CardContent class="space-y-4">
                    <div class="grid gap-4 md:grid-cols-2">
                        <div>
                            <h3 class="mb-2 font-medium">Static Alerts</h3>
                            <ul class="space-y-1 text-sm text-muted-foreground">
                        ...
                        <div>
                            <h3 class="mb-2 font-medium">Toast Notifications</h3>
                            <ul class="space-y-1 text-sm text-muted-foreground">
