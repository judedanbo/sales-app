...
import { BookOpen, Search, Clock } from 'lucide-vue-next';
...
const filteredToc = computed(() => {
    ...
    return props.tableOfContents.filter(item =>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full">
            ...
            <div class="w-80 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
                <div class="p-6">
                    ...
                    <div class="h-[calc(100vh-280px)] overflow-y-auto">
                        <div class="space-y-1">
                            <button
                                ...
                                class="block w-full text-left px-3 py-2 text-sm rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                                :class="{
                                    'pl-3': item.level === 1,
                                    'pl-6': item.level === 2,
                                    'pl-9': item.level === 3,
                                    'text-gray-900 dark:text-gray-100 font-medium': item.level === 1,
                ...
                <div class="h-[calc(100vh-80px)] overflow-y-auto">
                    <div class="max-w-4xl mx-auto p-8">
                        <Card>
                            ...
                            <CardContent>
                                <div 
                                    class="prose prose-gray dark:prose-invert max-w-none documentation-content"
                                    v-html="markdownHtml"
                                />
                            </CardContent>
                        </Card>
