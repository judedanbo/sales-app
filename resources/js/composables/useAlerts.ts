...
export const useAlerts = () => {
  ...
  const success = (message: string, options?: { title?: string; dismissible?: boolean; persistent?: boolean; priority?: AlertPriority; position?: AlertPosition; duration?: number }) => {
    return addAlert(message, 'success', options)
  }

  const error = (message: string, options?: { title?: string; dismissible?: boolean; persistent?: boolean; priority?: AlertPriority; position?: AlertPosition; duration?: number }) => {
    return addAlert(message, 'destructive', options)
  }

  const warning = (message: string, options?: { title?: string; dismissible?: boolean; persistent?: boolean; priority?: AlertPriority; position?: AlertPosition; duration?: number }) => {
    return addAlert(message, 'warning', options)
  }

  const info = (message: string, options?: { title?: string; dismissible?: boolean; persistent?: boolean; priority?: AlertPriority; position?: AlertPosition; duration?: number }) => {
    return addAlert(message, 'info', options)
  }

  // Convenience methods for priority-based alerts
  const critical = (message: string, options?: { title?: string; dismissible?: boolean; persistent?: boolean; position?: AlertPosition; duration?: number }) => {
    return addAlert(message, 'destructive', { ...options, priority: 'critical' })
  }

  const urgent = (message: string, options?: { title?: string; dismissible?: boolean; persistent?: boolean; position?: AlertPosition; duration?: number }) => {
