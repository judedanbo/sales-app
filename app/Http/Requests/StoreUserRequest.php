        ...
        return [
            ...
            'school_id' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    if ($userType && in_array($userType, [UserType::SCHOOL_ADMIN, UserType::PRINCIPAL, UserType::TEACHER])) {
                        if (empty($value)) {
                    ...
                    if ($userType && in_array($userType, [UserType::STAFF, UserType::ADMIN, UserType::AUDIT, UserType::SYSTEM_ADMIN])) {
                        if (! empty($value)) {
